<%-- 
    ...
    Created on : 21 jul 2020, 16:35:53
    Author     : izelo
--%>
...
<%
    ...
    List<Musica> musica = new MusicaDb().ListadoMusicaAlbum(cancion);
%>
<html>
    <head>
        ...
        <title>Consulta por álbum</title>
    </head>
    <body>
        <nav class="navbar navbar-fixed-top navbar-expand-lg navbar-dark bg-primary">
            ...
            <div class="form-inline my-2 my-lg-0" id="navbarTogglerDemo03">
                <div class="navbar-nav">
                    ...
                    <a class="nav-item nav-link active" href="#" role="button">Consulta por &aacute;lbum</a>
                </div>
            </div>
        </nav>
        <br></br>
        <div class="container">
            <table class="table table-hover table-bordered table-hover table-condensed">
                <h1 class="text-primary" style="font-size: 45px">Tabla de m&uacute;sica registrada por &aacute;lbum "<%= album%>"</h1>
                <br></br>
            ...
            <%--<a style="text-align: center" class="btn btn-lg btn-block btn-info active" href="repertorio.jsp" role="button">Regresar</a>--%>
        </div>
