<%-- 
    Document   : eliminaGe
    Created on : 27 jul 2020, 12:37:38
    Author     : izelo
--%>
...
<%
    ...
    MusicaDb elimina1 = new MusicaDb();
    elimina1.eliminaMusica(cancion);
    Catalogo catalogo = new Catalogo();
    catalogo.setIdGenero(idGenero);
    CatalogoDb elimina = new CatalogoDb();
    elimina.eliminarGenero(catalogo);
%>
<!DOCTYPE html>
<html>
    <head>
        ...
        <nav class="navbar navbar-fixed-top navbar-expand-lg navbar-dark bg-primary">
            ...
            <div class="form-inline my-2 my-lg-0" id="navbarTogglerDemo03">
                <div class="navbar-nav">
                    ...
                    <a class="nav-item nav-link active" href="#" role="button">G&eacute;nero eliminado</a>
                </div>
            </div>
        </nav><br></br>
        <div class="container">
            <br></br>
            <h1 style="text-align:center;color:red;font-size: 50px">G&eacute;nero eliminado</h1>
            <br></br>
        </div><br></br>
        <br></br>
