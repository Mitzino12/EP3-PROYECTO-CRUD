<%-- 
    Document   : formGenero
    Created on : 22 jul 2020, 12:08:35
    Author     : izelo
--%>
        ...
        <nav class="navbar navbar-fixed-top navbar-expand-lg navbar-dark bg-primary">
            ...
            <div class="form-inline my-2 my-lg-0" id="navbarTogglerDemo03">
                <div class="navbar-nav">
                    ...
                    <a class="nav-item nav-link active" href="#" role="button">Agregar g&eacute;nero</a>
                </div>
            </div>
        </nav>
        <br></br>
        <div class="container">
            <h1 style="font-size: 50px;color: blue"> Agregar un nuevo g&eacute;nero</h1><br></br>
            <form action="agregaGenero.jsp" method="POST">
                <div class="form-group">
                    <label style="font-size: 20px">Nuevo g&eacute;nero:</label><br></br>
                    <input type="text" class="form-control" placeholder="Género" name="genero" required/>
                </div >
                <input type="submit" align="center" class="btn btn-primary active" value="Agregar género"/>
                <a  class="btn btn-danger active" href="index.jsp" role="button">Regresar</a>
            </form>
        </div>
        <br></br>
        <br></br>
